...
func TestTurkeyFocusScoring(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "MERNIS citizen database leak",
			title:    "Threat Actor Leaks Alleged MERNIS Database on Hacker Forum",
			summary:  "Contains citizen records and ID numbers.",
			expected: 50,
			tag:      "TR-Focus",
		},
		{
			name:     "e-Nabiz and MHRS credential harvesting",
			title:    "Phishing Campaign Impersonates e-Nabiz and MHRS Portals",
			summary:  "Malicious domains targeting healthcare credentials.",
			expected: 50,
			tag:      "TR-Focus",
		},
		{
			name:     "Roketsan and STM defense contractor target",
			title:    "Espionage Threat Group Targets Engineers at Roketsan and STM",
			summary:  "Spear-phishing emails containing malware attachments.",
			expected: 50,
			tag:      "TR-Focus",
		},
		{
			name:     "Turkcell and Superonline telecom alert",
			title:    "DDoS Attacks Cause Temporary Disruption at Turkcell and Superonline",
			summary:  "DNS amplification flood detected.",
			expected: 50,
			tag:      "TR-Focus",
		},
		{
			name:     "Papara fintech credential stuffing",
			title:    "Credential Stuffing Wave Reported Targeting Papara User Accounts",
			summary:  "Financial application warnings issued.",
			expected: 50,
			tag:      "TR-Focus",
		},
		{
			name:     "AFAD earthquake phishing",
			title:    "Fraudsters Create Fake AFAD Donation Websites",
			summary:  "Users warned against suspicious payment links.",
			expected: 50,
			tag:      "TR-Focus",
		},
		{
